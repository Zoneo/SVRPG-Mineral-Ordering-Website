...
<head>
    <meta charset="utf-8" />
    <title>Joe's Mineral - How It Works</title>
</head>
<body onload="loadPageAssets();">
    ...
    <center>
        <div id="mainCentreBox">
            ...
            <hr /><br />
            <font id="header"><strong>How It Works</strong></font><br />
            <br />

            <table cellpadding="10">
               <tr>
                   <td><img src="http://46.101.18.121/SVRPGOrder/img/step1.png" id="step1Image" width="60" /></td>
                   <td>Submit an order on the homepage, filling in all of the relevent information.</td>
               </tr>
                <tr>
                    <td><img src="http://46.101.18.121/SVRPGOrder/img/step2.png" id="step2Image" width="60" /></td>
                    <td>Contact Joe_Maclesfield in game and the transaction will be completed within 48 hours unless stated otherwise.</td>
                </tr>
            </table>
